...
import SidebarMember from '../Component/Sidebar-member';
import { useHistory } from 'react-router-dom';

function MemberPersonal({ person }) {
  ...
  {person && person.user_type === 1 ? <SidebarAdmin /> : null}
  {person && person.user_type === 2 ? <SidebarMember /> : null}      </Box>
